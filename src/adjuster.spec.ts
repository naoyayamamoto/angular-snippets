...
describe("adjuster", () => {
  ...
  it("同値複数置換", () => {
    expect(
      adjuster("{{ ${variable} | uppercase }}{{ ${variable} | uppercase }}$0")
    ).toBe("{{ ${1:variable} | uppercase }}{{ ${1:variable} | uppercase }}$0");
  });
  ...
  it("複数置換", () => {
    expect(adjuster("{{ ${v1} | uppercase }}{{ ${v2} | uppercase }}$0")).toBe(
      "{{ ${1:v1} | uppercase }}{{ ${2:v2} | uppercase }}$0"
    );
  });
